...
# ############################################
#  UNDER-ACTUATED HEXAROTOR PARAMETERS
#  Same frame as tilthex but NO TILT (rx=0, ry=0)
# ############################################
...
def start():
    ...
    nhfc.set_servo_gain({'gain': {
        'Kpxy': 5, 'Kpz': 20, 'Kqxy': 4, 'Kqz': 1,
        'Kvxy': 25, 'Kvz': 20, 'Kwxy': 2, 'Kwz': 3,
        'Kixy': 0.01, 'Kiz': 0
    }})
...
#  WAYPOINT SEQUENCE
# ############################
# Same waypoints as 01-intro hexa-ua:
...
#  SAVE DATA
# ############################################
LOG_DIR = '/shared-workspace/logs/03a-trajectory/hexa-ua'
