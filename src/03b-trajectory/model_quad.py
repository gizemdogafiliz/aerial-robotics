...
def quintic_coeffs(q0, qf, T, v0=0, vf=0, a0=0, af=0):
    """Compute quintic polynomial coefficients (slide 21).
...
class TrajectoryGenerator:
    def __init__(self, waypoints):
        """waypoints: list of (t_start, duration, x, y, z, yaw)"""
        self.segments = []
        ...
        # rest-to-rest: velocity and acceleration = 0 at boundaries
...
# trajectory log (desired reference)
...
#  SAVE DATA
# ############################################
LOG_DIR = '/shared-workspace/logs/03b-trajectory/quad'
...
# generate maneuver-style log from ref_log
