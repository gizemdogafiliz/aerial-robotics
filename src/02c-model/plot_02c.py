...
LOG_DIR = os.path.expanduser('~/tk3lab-ws/logs/02c-model')
PLOT_DIR = os.path.join(SCRIPT_DIR, 'plots_02c')
...
# ============================================================
#  PLOT — 2x5 layout (tracking + errors + forces)
# ============================================================
plt.rcParams.update({'font.size': 9, 'figure.dpi': 120})

fig, axes = plt.subplots(2, 5, figsize=(22, 8))
fig.suptitle('Python Simulator + nhfc Controller (Assignment 2c)', fontsize=14)
...
fig.savefig(os.path.join(PLOT_DIR, 'plot_02c.png'), dpi=150, bbox_inches='tight')
print(f"\nPlot saved to: {PLOT_DIR}/plot_02c.png")
